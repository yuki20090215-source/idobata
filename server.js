...
http.createServer(async (req, res) => {
  ...
  // \u30D8\u30EB\u30B9\u30C1\u30A7\u30C3\u30AF
  if (path === '/api/health') {
    sendJSON(res, 200, {status:'ok', provider: CLAUDE_KEY ? 'claude' : 'gemini', hasClaudeKey:!!CLAUDE_KEY, hasGeminiKey:!!GEMINI_KEY, hasUnsplash:!!UNSPLASH_KEY, hasFirebase:!!FIREBASE_DB_URL}); return;
  }
