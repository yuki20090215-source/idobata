...
function buildClaudePostPrompts(postText, mode, interests) {
...
// ヘルスチェック
if (path === ‘/api/health’) {
sendJSON(res, 200, {status:‘ok’, provider: CLAUDE_KEY ? ‘claude’ : ‘gemini’, hasClaudeKey:!!CLAUDE_KEY, hasGeminiKey:!!GEMINI_KEY}); return;
}
